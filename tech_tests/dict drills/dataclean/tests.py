...
class TestCleaning(unittest.TestCase):
    ...
    def test_change_string_to_date(self):
        ...
        self.assertEqual(string_to_date,
        [{'emp id': '1', 'emp_first_name': 'Joe', 'emp_last_name': 'Bradigan', 'emp_job_title': 'Recruter', 'emp_salary': '10000', 'hiredate': '12-12-2001', 'departdate': '10-09-2020', 'grade': 'A'}, 
        {'emp id': '2', 'emp_first_name': 'Joe', 'emp_last_name': 'Justice', 'emp_job_title': 'PO', 'emp_salary': '10001', 'hiredate': '13-12-2001', 'departdate': '', 'grade': 'B'}, 
        {'emp id': '3', 'emp_first_name': 'Brad', 'emp_last_name': 'Dourif', 'emp_job_title': 'Actor', 'emp_salary': '10002', 'hiredate': '14-12-2001', 'departdate': '02-07-2007', 'grade': 'A'}, 
        {'emp id': '4', 'emp_first_name': 'Gisèle', 'emp_last_name': 'Chabir', 'emp_job_title': 'Lawyer', 'emp_salary': '10003', 'hiredate': '15-12-2001', 'departdate': '', 'grade': 'A'}, 
        {'emp id': '5', 'emp_first_name': 'Caroline', 'emp_last_name': 'Makanen', 'emp_job_title': 'Linguist', 'emp_salary': '10004', 'hiredate': '16-12-2001', 'departdate': '', 'grade': 'D'}, 
        {'emp id': '6', 'emp_first_name': 'Vladimir', 'emp_last_name': 'Doey', 'emp_job_title': 'Builder', 'emp_salary': '10005', 'hiredate': '17-12-2001', 'departdate': '', 'grade': 'A'}, 
        {'emp id': '7', 'emp_first_name': 'Basile', 'emp_last_name': 'Hervé', 'emp_job_title': 'Geek', 'emp_salary': '10006', 'hiredate': '18-12-2001', 'departdate': '14-06-2003', 'grade': 'B'}, 
        {'emp id': '8', 'emp_first_name': 'Voyager', 'emp_last_name': 'Opodo', 'emp_job_title': 'Traveler', 'emp_salary': '10007', 'hiredate': '19-12-2001', 'departdate': '', 'grade': 'E'}, 
        {'emp id': '9', 'emp_first_name': 'Céline', 'emp_last_name': 'Dion', 'emp_job_title': 'Dev', 'emp_salary': '10008', 'hiredate': '20-12-2001', 'departdate': '', 'grade': 'C'}, 
        {'emp id': '10', 'emp_first_name': 'René', 'emp_last_name': 'Canado', 'emp_job_title': 'Designer', 'emp_salary': '10009', 'hiredate': '21-12-2001', 'departdate': '25-10-2012', 'grade': 'A'}, 
        {'emp id': '11', 'emp_first_name': 'Vans', 'emp_last_name': 'Land of the Free', 'emp_job_title': 'Graphist', 'emp_salary': '10010', 'hiredate': '22-12-2001', 'departdate': '', 'grade': 'C'}]
        )             
